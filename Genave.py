...
if __name__ == "__main__":
    ...
    # Adding sensors for Genesee Ave to CA-52 improvement project
    tms.add_sensor(TrafficSensor("Genesee Ave Northbound Ramp Meter"))
    tms.add_sensor(TrafficSensor("Genesee Ave Southbound Exit for Nobel Drive"))
    tms.add_sensor(TrafficSensor("Genesee Ave Northbound Ramp Meter for La Jolla Pkwy"))
    tms.add_sensor(TrafficSensor("Genesee Ave Southbound Connector for La Jolla Pkwy"))
    tms.add_sensor(TrafficSensor("Genesee Ave Ramp Meter Add-ons"))
